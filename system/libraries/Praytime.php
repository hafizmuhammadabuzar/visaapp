...
class Praytime
{
    ...
    var $adjustHighLats = 3;    // adjusting method for higher latitudes
    ...
    */
    ...
    function Praytime($methodID = 0)
    {
        ...
        $this->methodParams[$this->FixedISHA] = array(19.5, 1, 0, 1, 90);
        $this->methodParams[$this->France]    = array(12, 1, 0, 0, 12);
        $this->methodParams[$this->Gulf]      = array(19.5, 1, 0, 1, 90);
    ...
    function getDatePrayerTimes($year, $month, $day, $latitude, $longitude, $timeZone)
    {
        ...
        return array($this->computeDayTimes(), $this->JDate);
    }
