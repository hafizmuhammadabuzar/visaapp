...
class Googlemaps {
    ...
    var $apiKey = 'AIzaSyBMzH2tlGjsq9xuc9QyHt2AEVVl2OdBvkI';       // If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
